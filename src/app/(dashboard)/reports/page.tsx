...
const propertyOccupancyDetails = [
  { property: "Grand Plaza Corporate Center", total: 4, occupied: 2, vacant: 2, rate: 50 },
  { property: "Oakridge Residential Towers", total: 4, occupied: 2, vacant: 2, rate: 50 },
  { property: "Skyline Industrial Park", total: 2, occupied: 1, vacant: 1, rate: 50 },
];
...
const recentTransactions = [
  { id: "TX-101", tenant: "TechStart Inc", property: "Grand Plaza", amount: 11000, date: "2026-06-01", status: "Paid" },
  { id: "TX-102", tenant: "Acme Corporation", property: "Grand Plaza", amount: 12000, date: "2026-06-01", status: "Paid" },
  { id: "TX-103", tenant: "Jane Miller", property: "Oakridge Towers", amount: 2500, date: "2026-06-01", status: "Paid" },
  { id: "TX-104", tenant: "John Doe", property: "Oakridge Towers", amount: 2500, date: "2026-05-28", status: "Overdue" },
];
...
const expiringLeases = [
  { id: "L-01", tenant: "TechStart Inc", unit: "Suite 201", expiry: "2026-06-30", daysLeft: 6 },
  { id: "L-02", tenant: "Jane Miller", unit: "Unit B-1", expiry: "2026-06-15", daysLeft: -9 }, // Overdue
  { id: "L-03", tenant: "John Doe", unit: "Unit A-1", expiry: "2026-06-30", daysLeft: 6 },
];
...
const activeWorkOrders = [
  { id: "WO-01", title: "Leaking Faucet in A-1", property: "Oakridge Towers", priority: "High", status: "In Progress" },
  { id: "WO-02", title: "Elevator Inspection", property: "Grand Plaza", priority: "Medium", status: "Scheduled" },
  { id: "WO-03", title: "lobby Light Bulbs Replacement", property: "Oakridge Towers", priority: "Low", status: "Open" },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-1.5 p-1 rounded-xl bg-zinc-100/80 dark:bg-zinc-800/40 w-fit">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === "Occupancy"
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === "Financial"
              ? "bg-white text-zinc-950 shadow-sm dark:bg-zinc-900 dark:text-zinc-50"
              : "text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-200"
            }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === "Leases"
              ? "bg-white text-zinc-950 shadow-sm dark:bg-zinc-900 dark:text-zinc-50"
              : "text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-200"
            }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === "Work Orders"
              ? "bg-white text-zinc-950 shadow-sm dark:bg-zinc-900 dark:text-zinc-50"
              : "text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-200"
            }`}
        >
      ...
      {activeTab === "Occupancy" && (
        <div className="space-y-6 animate-in fade-in duration-200">
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardContent className="flex items-center justify-between p-6">
                <div className="space-y-1">
                  ...
                  <p className="text-3xl font-bold tracking-tight">5</p>
                  <p className="text-xs text-muted-foreground">Available for lease</p>
                </div>
          ...
          <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center gap-2 text-zinc-900 dark:text-zinc-50">
                ...
                <h3 className="font-semibold text-base">Portfolio Occupancy Rate</h3>
              </div>
              <div className="flex items-baseline gap-3">
                <span className="text-4xl font-bold tracking-tight text-blue-600 dark:text-blue-400">50%</span>
              ...
              <div className="h-4 w-full bg-zinc-100 rounded-full overflow-hidden dark:bg-zinc-800">
                <div className="h-full bg-zinc-900 rounded-full dark:bg-zinc-100" style={{ width: "50%" }} />
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid gap-6 md:grid-cols-2">
                ...
                {isMounted ? (
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <YAxis domain={[0, 2]} ticks={[0, 0.5, 1, 1.5, 2]} axisLine={false} tickLine={false} tick={{ fontSize: 11 }} />
                      <Tooltip cursor={{ fill: "transparent" }} />
                      <Legend verticalAlign="bottom" height={36} iconType="rect" iconSize={12} wrapperStyle={{ fontSize: 12 }} />
                      <Bar dataKey="Occupied" fill="#2563EB" radius={[4, 4, 0, 0]} barSize={24} />
                      <Bar dataKey="Vacant" fill="#E2E8F0" radius={[4, 4, 0, 0]} barSize={24} />
                    </BarChart>
                  </ResponsiveContainer>
                ) : (
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardHeader className="pb-2">
                <CardTitle className="text-base font-semibold">Unit Status Distribution</CardTitle>
              </CardHeader>
              <CardContent className="h-[300px] flex flex-col justify-between">
                ...
                <div className="flex justify-center gap-6 pb-2 text-xs">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-zinc-600 dark:text-zinc-400 font-medium">Occupied: 50%</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <div className="h-3 w-3 rounded-full bg-green-500" />
                    <span className="text-zinc-600 dark:text-zinc-400 font-medium">Vacant: 50%</span>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardHeader className="pb-2">
                <CardTitle className="text-base font-semibold">Occupancy Trend (Last 5 Months)</CardTitle>
              </CardHeader>
              <CardContent className="h-[300px]">
                {isMounted ? (
                  <ResponsiveContainer width="100%" height="100%">
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardHeader className="pb-2">
                <CardTitle className="text-base font-semibold">Unit Types</CardTitle>
              </CardHeader>
              <CardContent className="h-[300px] flex flex-col justify-between">
                {isMounted ? (
                ...
                <div className="flex justify-center gap-4 pb-2 text-xs">
                  {unitTypesData.map((item) => (
                    <div key={item.name} className="flex items-center gap-1.5">
                      ...
                      <span className="text-zinc-600 dark:text-zinc-400 font-medium">{item.name}: {item.value}</span>
                    </div>
                  ))}
                </div>
              </CardContent>
          ...
          <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            <CardHeader className="pb-3">
              <CardTitle className="text-base font-semibold">Property Occupancy Detail</CardTitle>
            </CardHeader>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800 text-sm">
                    {propertyOccupancyDetails.map((row) => (
                      <tr key={row.property} className="hover:bg-zinc-50/30 dark:hover:bg-zinc-900/30 transition-colors">
                        <td className="px-6 py-4 font-semibold text-zinc-900 dark:text-zinc-100">{row.property}</td>
                        <td className="px-6 py-4 text-center font-medium text-zinc-600 dark:text-zinc-400">{row.total}</td>
                        <td className="px-6 py-4 text-center font-medium text-zinc-600 dark:text-zinc-400">{row.occupied}</td>
                        <td className="px-6 py-4 text-center font-medium text-zinc-600 dark:text-zinc-400">{row.vacant}</td>
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="h-2.5 w-32 bg-zinc-100 rounded-full overflow-hidden dark:bg-zinc-800 shrink-0">
                              <div className="h-full bg-zinc-950 rounded-full dark:bg-zinc-100" style={{ width: `${row.rate}%` }} />
                            </div>
                            <span className="text-xs font-bold text-amber-600 bg-amber-50 dark:bg-amber-950/20 dark:text-amber-400 px-2 py-0.5 rounded-full">{row.rate}%</span>
                          </div>
                        </td>
                      </tr>
                    ))}
        ...
        <div className="space-y-6 animate-in fade-in duration-200">
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardContent className="flex items-center justify-between p-6">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-green-600 font-medium flex items-center gap-0.5 mt-0.5">↗ 12% vs last month</p>
                </div>
                <div className="rounded-xl bg-green-50 p-3 text-green-600 dark:bg-green-950/40 dark:text-green-400">
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardContent className="flex items-center justify-between p-6">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-red-600 font-medium flex items-center gap-0.5 mt-0.5">↗ 5% inflation impact</p>
                </div>
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardContent className="flex items-center justify-between p-6">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">65.3% Net Margin</p>
                </div>
                <div className="rounded-xl bg-blue-50 p-3 text-blue-600 dark:bg-blue-950/40 dark:text-blue-400">
                  <CheckCircle className="h-6 w-6" />
                </div>
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardContent className="flex items-center justify-between p-6">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-amber-600 font-medium flex items-center gap-0.5 mt-0.5">1 tenant pending</p>
                </div>
                <div className="rounded-xl bg-orange-50 p-3 text-orange-600 dark:bg-orange-950/40 dark:text-orange-400">
                  <AlertTriangle className="h-6 w-6" />
                </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Card className="md:col-span-2 rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardHeader className="pb-2">
                <CardTitle className="text-base font-semibold">Revenue vs Operating Expenses</CardTitle>
              </CardHeader>
              <CardContent className="h-[300px]">
                {isMounted ? (
                  <ResponsiveContainer width="100%" height="100%">
          ...
          <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            <CardHeader className="pb-3">
              <CardTitle className="text-base font-semibold">Recent Billings & Receipts</CardTitle>
            </CardHeader>
            <CardContent className="p-0">
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800 text-sm">
                    {recentTransactions.map((tx) => (
                      <tr key={tx.id} className="hover:bg-zinc-50/30 dark:hover:bg-zinc-900/30 transition-colors">
                        <td className="px-6 py-4 font-mono font-semibold text-zinc-500">{tx.id}</td>
                        <td className="px-6 py-4 font-semibold text-zinc-900 dark:text-zinc-100">{tx.tenant}</td>
                        <td className="px-6 py-4 text-zinc-600 dark:text-zinc-400">{tx.property}</td>
                        <td className="px-6 py-4 text-center font-bold text-zinc-900 dark:text-zinc-100">${tx.amount.toLocaleString()}</td>
                        <td className="px-6 py-4 text-center text-zinc-500">{tx.date}</td>
                        <td className="px-6 py-4 text-center">
                          <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-semibold ${tx.status === "Paid"
        ...
        <div className="space-y-6 animate-in fade-in duration-200">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardContent className="flex items-center justify-between p-6">
                <div className="space-y-1">
                  <p className="text-sm font-medium text-muted-foreground">Expiring soon (90d)</p>
                  <p className="text-3xl font-bold tracking-tight">2</p>
                  <p className="text-xs text-amber-600 font-medium">Require renewals</p>
                </div>
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardContent className="flex items-center justify-between p-6">
                <div className="space-y-1">
                  <p className="text-sm font-medium text-muted-foreground">Average Lease Term</p>
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardContent className="flex items-center justify-between p-6">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-red-600 font-medium">Vacated or pending</p>
                </div>
                <div className="rounded-xl bg-red-50 p-3 text-red-600 dark:bg-red-950/40 dark:text-red-400">
                  <AlertTriangle className="h-6 w-6" />
                </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardHeader className="pb-2">
                <CardTitle className="text-base font-semibold">Lease Distribution Status</CardTitle>
              </CardHeader>
              <CardContent className="h-[300px] flex flex-col justify-between">
                {isMounted ? (
                  <div className="h-[230px] w-full">
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardHeader className="pb-2">
                <CardTitle className="text-base font-semibold">New Lease Signings Trend</CardTitle>
              </CardHeader>
              <CardContent className="h-[300px]">
                {isMounted ? (
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#F1F5F9" />
                      <XAxis dataKey="month" axisLine={false} tickLine={false} tick={{ fontSize: 11 }} />
                      <YAxis domain={[0, 4]} ticks={[0, 1, 2, 3, 4]} axisLine={false} tickLine={false} tick={{ fontSize: 11 }} />
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-zinc-100 bg-zinc-50/50 text-xs font-semibold text-zinc-500 uppercase tracking-wider dark:border-zinc-800 dark:bg-zinc-900/50">
                      ...
                      <th className="px-6 py-3.5 text-center">Action Required</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800 text-sm">
                    {expiringLeases.map((lease) => (
                      <tr key={lease.id} className="hover:bg-zinc-50/30 dark:hover:bg-zinc-900/30 transition-colors">
                        <td className="px-6 py-4 font-mono font-semibold text-zinc-500">{lease.id}</td>
                        <td className="px-6 py-4 font-semibold text-zinc-900 dark:text-zinc-100">{lease.tenant}</td>
                        <td className="px-6 py-4 text-zinc-600 dark:text-zinc-400">{lease.unit}</td>
                        <td className="px-6 py-4 text-center font-medium text-zinc-500">{lease.expiry}</td>
                        <td className="px-6 py-4 text-center">
                          <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-semibold ${lease.daysLeft > 0
                              ? "bg-amber-50 text-amber-600 dark:bg-amber-950/20 dark:text-amber-400"
                              : "bg-red-50 text-red-600 dark:bg-red-950/20 dark:text-red-400"
                            }`}>
                            {lease.daysLeft > 0 ? `Expires in ${lease.daysLeft}d` : `Expired ${Math.abs(lease.daysLeft)}d ago`}
                          </span>
                        </td>
                      </tr>
                    ))}
        ...
        <div className="space-y-6 animate-in fade-in duration-200">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <CardContent className="flex items-center justify-between p-6">
                <div className="space-y-1">
                  <p className="text-sm font-medium text-muted-foreground">In Progress / Sched</p>
                  <p className="text-3xl font-bold tracking-tight">2</p>
                </div>
                <div className="rounded-xl bg-orange-50 p-3 text-orange-600 dark:bg-orange-950/40 dark:text-orange-400">
                  <Clock className="h-6 w-6" />
                ...
                {isMounted ? (
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#F1F5F9" />
                      <XAxis dataKey="name" axisLine={false} tickLine={false} tick={{ fontSize: 11 }} />
                      <YAxis domain={[0, 3]} ticks={[0, 1, 2, 3]} axisLine={false} tickLine={false} tick={{ fontSize: 11 }} />
                      <Tooltip formatter={(v) => `${v} Orders`} />
          ...
          <Card className="rounded-xl border border-zinc-100 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            <CardHeader className="pb-3">
              <CardTitle className="text-base font-semibold">Recent Work Order Tasks</CardTitle>
            </CardHeader>
            <CardContent className="p-0">
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800 text-sm">
                    {activeWorkOrders.map((order) => (
                      <tr key={order.id} className="hover:bg-zinc-50/30 dark:hover:bg-zinc-900/30 transition-colors">
                        <td className="px-6 py-4 font-mono font-semibold text-zinc-500">{order.id}</td>
                        <td className="px-6 py-4 font-semibold text-zinc-900 dark:text-zinc-100">{order.title}</td>
                        <td className="px-6 py-4 text-zinc-600 dark:text-zinc-400">{order.property}</td>
                        <td className="px-6 py-4 text-center">
                          <span className={`inline-block px-2.5 py-0.5 rounded-full text-xs font-semibold ${order.priority === "High"
                              ? "bg-red-50 text-red-600 dark:bg-red-950/20 dark:text-red-400"
                        ...
                        <td className="px-6 py-4 text-center text-zinc-500 font-medium">{order.status}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
