...
export const mockLeads: Lead[] = [
  {
    ...
    targetProperty: "Green Valley Residency",
  ...
  },
  {
    ...
    targetProperty: "Lake View Apartments",
    leadType: "Residential",
    probability: 30,
...
export const mockEmployees = [
  {
    ...
    presentAddress: "12 Gulshan Avenue, Dhaka",
    permanentAddress: "12 Gulshan Avenue, Dhaka",
    department: "Sales",
  ...
  },
  {
    ...
    presentAddress: "45 Banani, Dhaka",
    permanentAddress: "45 Banani, Dhaka",
    department: "Sales",
    ...
    employeeStatus: "Active",
    fatherName: "Jahan Ali",
    motherName: "Roksana Jahan",
    spouseName: "Imran Hossain",
    emergencyContactName: "Imran Hossain",
    emergencyContactRelationship: "Spouse",
    emergencyContactNumber: "01912345678",
  ...
  },
  {
    ...
    presentAddress: "78 Motijheel, Dhaka",
    permanentAddress: "Village: Comilla",
    department: "Finance",
    ...
    emergencyContactNumber: "01512345678",
...
export const mockPayrollRecords: PayrollRecord[] = [
  {
    ...
    overtimeHours: 8,
    overtimePay: 3115.44,
    bonusAllowance: 500.0,
    taxWithheld: 1200.0,
    net: 41915.44,
    approvedBy: "Nusrat Jahan",
    comments: "Includes Q2 sales incentive bonus.",
    status: "Processed",
  ...
  },
  {
    ...
    overtimeHours: 0,
    overtimePay: 0.0,
    bonusAllowance: 1000.0,
    taxWithheld: 2500.0,
    net: 60700.0,
    approvedBy: "HR Director",
    comments: "Management allowance included.",
    status: "Processed",
